        ...
        return {
            ...
            link: function(a, f, b, c, m) {
                function v() {
                    l && (g.cancel(l), l = null);
                    p && (p.$destroy(), p = null);
                    q && (l = g.leave(q), l.done(function(a) {
                        !1 !== a && (l = null)
                    }), q = null)
                }
                ...
                function E() {
                    ...
                    if (d.isDefined(b && b.$template)) {
                        var b = a.$new(),
                            c = t.current;
                        q = m(b, function(b) {
                            g.enter(b, null, q || f).done(function(b) {
    ...
    var x,
        y, F, G, z = d.module("ngRoute", []).info({
            ...
            this.when = function(a, f) {
                ...
                b = b || f;
                d.isUndefined(b.reloadOnUrl) && (b.reloadOnUrl = !0);
            ...
            this.$get = ["$rootScope", "$location", "$routeParams", "$q", "$injector", "$templateRequest", "$sce", "$browser", function(a, f, b, c, m, k, u, p) {
                function q(e) {
                    var h = s.current;
                    n = C();
                    (y = !D && n && h && n.$$route ===
                ...
                function l() {
                    ...
                    if (y) e.params = h.params, d.copy(e.params, b), a.$broadcast("$routeUpdate", e);
                        ...
                        H.then(w).then(z).then(function(c) {
                            ...
                            h === s.current && a.$broadcast("$routeChangeError", h, e, b)
                        }).finally(function() {
                            p.$$completeOutstandingRequest(G)
                        })
                    }
                }
                ...
                function B(a) {
                    var b, c;
                    d.isDefined(b = a.template) ? d.isFunction(b) && (b = b(a.params)) :
                        d.isDefined(c = a.templateUrl) && (d.isFunction(c) && (c = c(a.params)), d.isDefined(c) && (a.loadedTemplateUrl = u.valueOf(c), b = k(c)));
                    return b
                }
